...
function MainApp() {
  ...
  const renderContent = () => {
    ...
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <p className="text-[#8EA8AA] mb-6 max-w-md">{language === 'ar' ? 'عذراً، الصفحة التي تبحث عنها غير موجودة أو تم نقلها.' : 'Sorry, the page you are looking for does not exist or has been moved.'}</p>
        <button
          onClick={() => navigate('/')}
  ...
  return (
    <div className={`min-h-screen brand-mesh bg-[#061719] text-[#F3FBFB] selection:bg-[#0E5257] selection:text-white ${language === 'ar' ? 'font-sans' : 'font-sans'}`}>
