      ...
      <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-[#8EA8AA] max-w-sm mx-auto leading-relaxed">{message}</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => onNavigate('/')}
              className="w-full flex items-center justify-center gap-2 bg-[#0A1E20] hover:bg-[#0B2528] text-[#B9D0D1] py-3 rounded-2xl text-xs font-bold border border-[#0B2528] transition cursor-pointer"
            >
      ...
      <div className="min-h-[70vh] flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md text-center space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-[#8EA8AA] max-w-sm mx-auto leading-relaxed">
