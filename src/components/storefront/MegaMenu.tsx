...
export const MegaMenu: React.FC<MegaMenuProps> = ({ isOpen, onClose, onNavigate }) => {
  ...
  return (
    <div className="absolute top-full left-1/2 -translate-x-1/2 w-[90vw] max-w-6xl bg-[#0A1E20] border border-[#0B2528] rounded-2xl shadow-2xl p-6 grid grid-cols-12 gap-6 z-50 text-[#F3FBFB] backdrop-blur-md mt-2">
        ...
        {categories.map(cat => {
          ...
          return (
            <div
              ...
              className="group p-4 rounded-xl bg-[#061719]/60 hover:bg-[#0E5257]/20 border border-[#0B2528] hover:border-[#6CC6C9]/50 transition cursor-pointer flex items-start gap-3.5"
            >
              <div className="p-2.5 rounded-lg bg-[#0E5257]/20 text-[#6CC6C9] group-hover:scale-110 transition">
                <IconComponent className="w-5 h-5" />
              </div>
              <div>
                <h4 className="font-bold text-sm text-[#F3FBFB] group-hover:text-[#6CC6C9] transition flex items-center gap-1.5">
                ...
                <p className="text-xs text-[#8EA8AA] mt-1 line-clamp-2">
      ...
      <div className="col-span-4 rounded-xl overflow-hidden relative group border border-[#0B2528] min-h-[220px] flex flex-col justify-end p-5">
        <img
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-[#061719] via-[#061719]/60 to-transparent"></div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-xs text-[#B9D0D1] mt-1 mb-3">
