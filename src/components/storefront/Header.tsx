...
export const Header: React.FC<HeaderProps> = ({ onOpenSearch, onNavigate, currentPath = '/', onOpenAuth }) => {
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          {announcement.link && announcement.show_button !== false && (
            <button
              ...
              className="shrink-0 hidden sm:flex items-center gap-1.5 rounded-full bg-gradient-to-l from-[#6CC6C9] to-[#0E5257] text-[#061719] px-4 sm:px-5 py-2 text-xs sm:text-sm font-extrabold cursor-pointer hover:brightness-110 transition shadow-[0_6px_20px_-6px_rgba(217,155,38,0.65)]"
            >
              <span>
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#061719]/85 text-[#F3FBFB] border-b border-[#0B2528] transition-all backdrop-blur-xl max-w-full overflow-x-clip">
        ...
        <div className="flex items-center justify-between h-16 sm:h-20 gap-1.5 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            <button
              ...
              className="lg:hidden p-1.5 sm:p-2 rounded-lg text-[#6CC6C9] hover:bg-[#0A1E20] transition cursor-pointer"
          ...
          >
            <button
              onClick={() => onNavigate('/')}
              className={`hover:text-[#6CC6C9] transition py-1 border-b-2 cursor-pointer ${currentPath === '/' ? 'text-[#6CC6C9] border-[#6CC6C9]' : 'border-transparent text-[#D8E8E9]'
                }`}
            >
              {t('الرئيسية', 'Home')}
            </button>
            ...
            >
              <button
                ...
                className={`flex items-center gap-1.5 hover:text-[#6CC6C9] transition py-1 border-b-2 cursor-pointer ${(currentPath || '').startsWith('/products') || (currentPath || '').startsWith('/category')
                    ...
                    : 'border-transparent text-[#D8E8E9]'
                  }`}
              >
            ...
            <button
              ...
              className={`hover:text-[#6CC6C9] transition py-1 border-b-2 cursor-pointer ${currentPath === '/about' ? 'text-[#6CC6C9] border-[#6CC6C9]' : 'border-transparent text-[#D8E8E9]'
                }`}
            >
            ...
            <button
              ...
              className={`hover:text-[#6CC6C9] transition py-1 border-b-2 cursor-pointer ${currentPath === '/wholesale' ? 'text-[#6CC6C9] border-[#6CC6C9]' : 'border-transparent text-[#D8E8E9]'
                }`}
            >
          ...
          <div className="flex items-center gap-1 sm:gap-2 lg:gap-3 shrink-0">
            ...
            <div className="relative hidden md:block">
              <button
                ...
                className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs bg-[#0A1E20] text-[#B9D0D1] hover:text-[#F3FBFB] hover:bg-[#0B2528] transition border border-[#0B2528] cursor-pointer"
              >
                <span>{currency}</span>
              ...
              {isCurrencyDropdownOpen && (
                <div className="absolute top-full mt-2 left-0 right-0 w-24 bg-[#0A1E20] border border-[#0B2528] rounded-xl shadow-2xl py-1 z-50">
                  {Object.keys(currencies).map(c => (
                    <button
                      ...
                      className={`w-full text-center px-3 py-1.5 text-xs hover:bg-[#0E5257]/30 transition cursor-pointer ${currency === c ? 'text-[#6CC6C9] font-bold' : 'text-[#D8E8E9]'
                        }`}
                    >
                      {c}
                    </button>
            ...
            <button
              ...
              className="hidden md:flex p-2 rounded-lg text-[#B9D0D1] hover:text-[#F3FBFB] hover:bg-[#0A1E20] transition text-xs font-semibold items-center gap-1 border border-[#0B2528] cursor-pointer"
            ...
            <button
              ...
              className="p-1.5 sm:p-2 rounded-lg text-[#B9D0D1] hover:text-[#6CC6C9] hover:bg-[#0A1E20] transition cursor-pointer"
              title={t('بحث', 'Search')}
            >
            ...
            <button
              ...
              className="relative p-1.5 sm:p-2 rounded-lg text-[#B9D0D1] hover:text-[#6CC6C9] hover:bg-[#0A1E20] transition cursor-pointer hidden sm:flex"
            ...
            <button
              ...
              className="p-1.5 sm:p-2 rounded-lg text-[#B9D0D1] hover:text-[#6CC6C9] hover:bg-[#0A1E20] transition flex items-center gap-1 cursor-pointer"
