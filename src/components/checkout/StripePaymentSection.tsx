...
const PaymentForm: React.FC<{
  ...
  return (
    <form onSubmit={handlePay} className="space-y-4">
      <div className="bg-[#061719] border border-[#0B2528] rounded-2xl p-4">
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-start justify-between">
        <p className="text-xs text-[#B9D0D1]">
        ...
        <button
          onClick={onCancel}
          className="p-1 rounded-lg text-[#8EA8AA] hover:text-white hover:bg-[#0B2528] cursor-pointer shrink-0"
