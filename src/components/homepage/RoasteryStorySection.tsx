...
export const RoasteryStorySection: React.FC<RoasteryStorySectionProps> = ({
  ...
  return (
    <motion.section
      ...
      className="py-16 bg-[#061719] border-b border-[#0B2528]/60 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm sm:text-base text-[#B9D0D1] leading-relaxed">
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            <motion.div
              ...
              className="p-4 rounded-2xl bg-[#0A1E20] border border-[#0B2528]"
            >
              <span className="font-extrabold text-2xl text-[#6CC6C9]">85+</span>
              <p className="text-xs text-[#8EA8AA] mt-1 font-semibold">{t('تقييم جمعية القهوة المختصة SCA', 'SCA Certified Specialty Score')}</p>
            </motion.div>
            ...
            <motion.div
              ...
              className="p-4 rounded-2xl bg-[#0A1E20] border border-[#0B2528]"
            >
              <span className="font-extrabold text-2xl text-[#6CC6C9]">100%</span>
              <p className="text-xs text-[#8EA8AA] mt-1 font-semibold">{t('محاصيل طازجة محمصة أسبوعياً', 'Fresh Weekly Micro-Roasts')}</p>
            </motion.div>
          </div>
          ...
          <div className="pt-2">
            <button
              ...
              className="bg-[#0A1E20] hover:bg-[#0E5257] text-white px-6 py-3 rounded-xl text-xs font-bold border border-[#0B2528] transition cursor-pointer"
            >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="relative rounded-3xl overflow-hidden border border-[#0B2528] shadow-2xl aspect-video bg-[#0A1E20] group"
        >
          {isPlaying ? (
            <iframe
            ...
            <>
              ...
              <div className="absolute inset-0 bg-black/50 backdrop-blur-[2px] flex items-center justify-center">
                <button
                  ...
                  className="w-20 h-20 rounded-full bg-[#0E5257] hover:bg-[#6CC6C9] text-white flex items-center justify-center transition transform hover:scale-110 shadow-2xl shadow-[#0E5257]/50 cursor-pointer"
