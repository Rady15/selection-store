...
export const CoffeeFinderCallout: React.FC<CoffeeFinderCalloutProps> = ({
  ...
  return (
    <motion.section
      ...
      className="py-12 bg-[#061719]"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-[#0A1E20] via-[#0B2528] to-[#0A1E20] border border-[#0E5257]/40 p-8 sm:p-12 shadow-2xl flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#061719] via-[#061719]/30 to-transparent flex items-end p-4">
