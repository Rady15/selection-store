...
export const AdminCouponsManager: React.FC = () => {
 ...
 <h3 className="font-bold text-base text-[#1A2E30]">{t('إضافة كوبون خصم جديد', 'Create New Coupon')}</h3>
 ...
 <div>
 <label className="block text-[#4A6869] mb-1 font-semibold">{t('حد أقصى للخصم (﷼)', 'Max Discount (﷼)')}</label>
