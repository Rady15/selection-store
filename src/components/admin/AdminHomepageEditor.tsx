...
export const AdminHomepageEditor: React.FC = () => {
 ...
 <div className="p-2.5 rounded-xl bg-[#FFFFFF] text-[#6CC6C9]">
 ...
 disabled={index === 0}
 className="p-1.5 rounded-lg bg-[#FFFFFF] text-[#6B8C8E] hover:text-[#6CC6C9] disabled:opacity-30 transition cursor-pointer"
 >
