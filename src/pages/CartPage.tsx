  ...
  return (
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Page Header */}
        <div className="flex items-center justify-between border-b border-[#0B2528] pb-6">
        ...
        {items.length === 0 ? (
          <div className="text-center py-20 bg-[#0A1E20] border border-[#0B2528] rounded-3xl p-8 space-y-4">
            <ShoppingBag className="w-16 h-16 text-[#8EA8AA] mx-auto" />
            <h3 className="font-extrabold text-xl text-white">
              {t('سلة التسوق فارغة حالياً', 'Your Cart is Currently Empty')}
            </h3>
            <p className="text-xs text-[#8EA8AA] max-w-sm mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-[#0A1E20] border border-[#0B2528] space-y-2">
                <div className="flex items-center justify-between text-xs font-bold">
                  <div className="flex items-center gap-2 text-[#B9D0D1]">
                ...
                <div className="w-full bg-[#061719] h-2 rounded-full overflow-hidden border border-[#0B2528]">
                  <div
              ...
              <div className="space-y-3">
                {items.map(item => (
                  <div
                    key={item.id}
                    className="p-4 rounded-2xl bg-[#0A1E20] border border-[#0B2528] flex flex-col sm:flex-row items-center justify-between gap-4"
                  >
                    <div className="flex items-center gap-4 w-full sm:w-auto">
                      <div className="w-20 h-20 rounded-2xl overflow-hidden bg-[#061719] flex-shrink-0 border border-[#0B2528]">
                        <img
                      ...
                      <div className="space-y-1 min-w-0 flex-1">
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          <span className="text-[10px] bg-[#0B2528] text-[#B9D0D1] px-2.5 py-0.5 rounded font-bold">
                    ...
                    <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto pt-2 sm:pt-0 border-t sm:border-0 border-[#0B2528]">
                      <div className="flex items-center border border-[#0B2528] rounded-xl bg-[#061719]">
                        <button
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-5 sticky top-28 shadow-2xl">
                <h3 className="font-extrabold text-lg text-white border-b border-[#0B2528] pb-3">
                  {t('ملخص الفاتورة', 'Order Summary')}
                </h3>

                {/* Coupon Code Input */}
                <div className="space-y-2">
                  <label className="text-xs font-bold text-[#8EA8AA] block">{t('كود الخصم / الكوبون', 'Promo Code')}</label>
                  {appliedCoupon ? (
                    ...
                    <form onSubmit={handleCouponSubmit} className="flex gap-2">
                      <div className="relative flex-1">
                        <Tag className="w-3.5 h-3.5 absolute left-3 top-1/2 -translate-y-1/2 text-[#8EA8AA]" />
                        <input
                          type="text"
                          value={couponInput}
                          onChange={e => setCouponInput(e.target.value)}
                          placeholder="WELCOME10"
                          className="w-full bg-[#061719] border border-[#0B2528] rounded-xl pl-9 pr-3 py-2 text-xs text-white uppercase placeholder-[#8EA8AA]/50 focus:outline-none focus:border-[#6CC6C9]"
                        />
                      </div>
                      <button
                        type="submit"
                        className="bg-[#0B2528] hover:bg-[#0E5257] text-white px-4 py-2 rounded-xl text-xs font-bold transition cursor-pointer"
                      >
                        {t('تطبيق', 'Apply')}
                      </button>
                    </form>
                ...
                {/* Numbers Itemization */}
                <div className="space-y-2 text-xs text-[#B9D0D1] pt-2 border-t border-[#0B2528]">
                  ...
                  <div className="flex justify-between text-white font-extrabold text-lg pt-3 border-t border-[#0B2528]">
                ...
                <p className="text-[10px] text-[#8EA8AA] text-center flex items-center justify-center gap-1">
