...
export const AboutPage: React.FC<PageProps> = () => {
  ...
  return (
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-10">

        <div className="text-center space-y-4">
          <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#0E5257] to-[#6CC6C9] p-0.5 mx-auto shadow-xl">
            <div className="w-full h-full bg-[#061719] rounded-[14px] flex items-center justify-center">
          ...
          <p className="text-xs sm:text-sm text-[#8EA8AA] max-w-xl mx-auto leading-relaxed">
            {t(
        ...
        {/* Detailed Story Box */}
        <div className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-6 text-xs sm:text-sm text-[#B9D0D1] leading-relaxed shadow-xl">
          <h3 className="text-lg font-bold text-white border-b border-[#0B2528] pb-3">
          ...
          <div className="p-4 rounded-2xl bg-[#061719] border border-[#0B2528] text-center font-bold text-[#6CC6C9]">
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs sm:text-sm text-[#8EA8AA]">
        ...
        {submitted ? (
          <div className="p-8 rounded-3xl bg-[#0A1E20] border border-emerald-500/40 text-center space-y-3 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-4 text-xs shadow-xl">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('اسم المقهى / الشركة', 'Company / Cafe Name')}</label>
                <input
                  type="text"
                  required
                  value={company}
                  ...
                  className="w-full bg-[#061719] border border-[#0B2528] rounded-xl p-3 text-white focus:outline-none focus:border-[#6CC6C9]"
                />
              </div>

              <div>
                <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('اسم المسؤول', 'Contact Person')}</label>
                <input
                  type="text"
                  required
                  value={name}
              ...
              <div>
                <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('رقم الجوال والواتساب', 'Phone Number')}</label>
                <input
                  type="tel"
                  required
                  value={phone}
              ...
              <div>
                <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('البريد الإلكتروني', 'Email Address')}</label>
                <input
                  type="email"
                  required
                  value={email}
              ...
              <div>
                <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('المدينة', 'City')}</label>
                <input
                  type="text"
                  required
                  value={city}
              ...
              <div>
                <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('حجم الاستهلاك الشهري التقديري', 'Monthly Est. Volume')}</label>
                <select
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-[#8EA8AA]">{t('نحن هنا لمساعدتك والإجابة عن جميع استفساراتك حول الطلبات والشحن.', 'Our customer support team is available 7 days a week.')}</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
          <div className="p-6 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-2 shadow">
            <Phone className="w-6 h-6 text-[#6CC6C9] mx-auto" />
            <h4 className="font-bold text-sm text-white">{t('الهاتف المجاني', 'Toll Free')}</h4>
            <p className="text-xs text-[#8EA8AA]">9200 12345</p>
          </div>
          <div className="p-6 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-2 shadow">
            ...
            <p className="text-xs text-[#8EA8AA]">+966 50 000 0000</p>
          </div>
          <div className="p-6 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-2 shadow">
            <Mail className="w-6 h-6 text-[#6CC6C9] mx-auto" />
            <h4 className="font-bold text-sm text-white">{t('البريد الإلكتروني', 'Email Support')}</h4>
            <p className="text-xs text-[#8EA8AA]">care@selection.coffee</p>
          </div>
        </div>

        <div className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-4">
          <h3 className="font-bold text-base text-white border-b border-[#0B2528] pb-3">
          ...
          {submitted ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input required type="text" value={name} onChange={e => setName(e.target.value)} placeholder={t('الاسم الكريم', 'Your Name')} className="bg-[#061719] border border-[#0B2528] rounded-xl p-3 text-white focus:outline-none focus:border-[#6CC6C9]" />
                <input required type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder={t('البريد الإلكتروني', 'Your Email')} className="bg-[#061719] border border-[#0B2528] rounded-xl p-3 text-white focus:outline-none focus:border-[#6CC6C9]" />
              </div>
              <input type="tel" value={phone} onChange={e => setPhone(e.target.value)} placeholder={t('رقم الجوال (اختياري)', 'Phone (optional)')} className="w-full bg-[#061719] border border-[#0B2528] rounded-xl p-3 text-white focus:outline-none focus:border-[#6CC6C9]" />
              <textarea required rows={4} value={message} onChange={e => setMessage(e.target.value)} placeholder={t('نص الرسالة أو الاستفسار...', 'Your Message...')} className="w-full bg-[#061719] border border-[#0B2528] rounded-xl p-3 text-white focus:outline-none focus:border-[#6CC6C9]" />
  ...
  return (
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-6">
        ...
        <div className="p-8 bg-[#0A1E20] border border-[#0B2528] rounded-3xl text-xs text-[#B9D0D1] space-y-6 leading-relaxed">
          ...
          <p className="text-[10px] text-[#8EA8AA] pt-4 border-t border-[#0B2528]">
  ...
  return (
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-6">
        ...
        <div className="p-8 bg-[#0A1E20] border border-[#0B2528] rounded-3xl text-xs text-[#B9D0D1] space-y-4 leading-relaxed">
          ...
          <p className="p-3 bg-[#061719] rounded-xl text-[#6CC6C9] font-bold">
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-[#8EA8AA]">{t('كل ما تحتاج معرفته عن التحميص، درجات الطحن، الشحن، وطرق الدفع.', 'Everything you need to know about roast dates, grinding & order fulfillment.')}</p>
        </div>

        {/* Search FAQ */}
        <div className="relative max-w-md mx-auto">
          <Search className="w-4 h-4 text-[#8EA8AA] absolute right-3 top-3.5" />
          <input
            type="text"
            value={searchTerm}
            onChange={e => setSearchTerm(e.target.value)}
            placeholder={t('ابحث في الأسئلة الشائعة...', 'Search FAQs...')}
            className="w-full bg-[#0A1E20] border border-[#0B2528] rounded-xl pr-10 pl-4 py-3 text-xs text-white focus:outline-none focus:border-[#6CC6C9]"
          />
        </div>
        ...
        <div className="space-y-3">
          {filteredFaqs.map((faq, idx) => {
            ...
            return (
              <div key={idx} className="bg-[#0A1E20] border border-[#0B2528] rounded-2xl overflow-hidden transition">
                <button
                  onClick={() => setOpenIndex(isOpen ? null : idx)}
                  className="w-full text-start p-5 flex items-center justify-between font-bold text-sm text-white hover:text-[#6CC6C9] cursor-pointer"
                >
                  <span>{t(faq.q_ar, faq.q_en)}</span>
                  {isOpen ? <ChevronUp className="w-4 h-4 text-[#6CC6C9]" /> : <ChevronDown className="w-4 h-4 text-[#8EA8AA]" />}
                </button>
                {isOpen && (
                  <div className="px-5 pb-5 pt-0 text-xs text-[#B9D0D1] leading-relaxed border-t border-[#0B2528]/50 mt-1">
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-[#8EA8AA]">{t('الوصفات الاحترافية ونسب القهوة للماء المعتمدة من خبراؤنا بالمحمصة.', 'Master Coffee-to-Water ratios and pouring techniques.')}</p>
        </div>
          ...
          {(Object.keys(recipes) as Array<keyof typeof recipes>).map(key => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold transition cursor-pointer border ${selectedMethod === key
                  ...
                  : 'bg-[#0A1E20] text-[#8EA8AA] border-[#0B2528] hover:text-white'
                }`}
            >
              {key.toUpperCase()}
            </button>
        ...
        <div className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-6 shadow-xl">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 border-b border-[#0B2528] pb-6">
            <div>
              <h3 className="font-bold text-lg text-white font-serif">{currentRecipe.title_ar}</h3>
              <p className="text-xs text-[#8EA8AA] mt-1">{t('درجة الحرارة المثالية:', 'Ideal Temp:')} <span className="text-[#6CC6C9] font-bold">{currentRecipe.temp}</span></p>
            </div>

            <div className="bg-[#061719] p-4 rounded-2xl border border-[#0B2528] text-center w-full sm:w-auto">
              <span className="text-[10px] text-[#8EA8AA] block uppercase">{t('نسبة القهوة للماء', 'Brew Ratio')}</span>
              <span className="text-xl font-extrabold text-[#6CC6C9]">1 : {currentRecipe.ratio}</span>
            </div>
          </div>

          {/* Coffee Slider */}
          <div className="space-y-3 bg-[#061719] p-6 rounded-2xl border border-[#0B2528]">
            ...
            <div className="pt-2 border-t border-[#0B2528] flex justify-between items-center text-xs">
              <span className="text-[#8EA8AA]">{t('كمية الماء المطلوبة بالمليلتر:', 'Required Water (ml):')}</span>
          ...
          <div className="space-y-3">
            ...
            <ol className="space-y-2.5 text-xs text-[#B9D0D1]">
              {currentRecipe.steps_ar.map((step, i) => (
                <li key={i} className="flex items-start gap-3 bg-[#061719]/50 p-3 rounded-xl border border-[#0B2528]/40">
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-10">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-xs sm:text-sm text-[#8EA8AA] max-w-lg mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-6 flex flex-col justify-between shadow-xl">
            <div className="space-y-3">
              ...
              <p className="text-xs text-[#8EA8AA]">{t('كيسان قهوة مختصة (250غ لكل كيس) بتنوع محاصيل فاكهية ومغسولة.', '2 bags of single origin specialty crops monthly.')}</p>
              <div className="pt-2 text-2xl font-extrabold text-[#6CC6C9]">
                119 <span className="text-xs text-[#8EA8AA] font-normal">﷼ / شهرياً</span>
              </div>
            </div>
          ...
          <div className="p-8 rounded-3xl bg-[#0A1E20] border-2 border-[#6CC6C9] space-y-6 flex flex-col justify-between shadow-2xl relative">
            ...
            <div className="space-y-3 pt-2">
              ...
              <p className="text-xs text-[#8EA8AA]">{t('3 أكياس قهوة مختصة مختارة بعناية من أحدث المحاصيل العالمية الحصرية.', '3 bags of rare high-score micro-lots.')}</p>
              <div className="pt-2 text-3xl font-extrabold text-[#6CC6C9]">
                169 <span className="text-xs text-[#8EA8AA] font-normal">﷼ / شهرياً</span>
              </div>
            </div>
          ...
          <div className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-6 flex flex-col justify-between shadow-xl">
            <div className="space-y-3">
              ...
              <p className="text-xs text-[#8EA8AA]">{t('30 ظرف قهوة مقطرة جاهزة سريع التحضير في العمل والأسفار.', '30 ready drip bags perfect for work & travel.')}</p>
              <div className="pt-2 text-2xl font-extrabold text-[#6CC6C9]">
                139 <span className="text-xs text-[#8EA8AA] font-normal">﷼ / شهرياً</span>
              </div>
            </div>
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-[#8EA8AA]">{t('تفضل بزيارتنا لتذوق أحدث المحاصيل طازجة واستلام طلباتك مباشرة.', 'Visit our flagship espresso bar in Riyadh or order drive-thru pickup.')}</p>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-6 shadow-xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-xs text-[#B9D0D1]">
            ...
            <div className="rounded-2xl overflow-hidden border border-[#0B2528] min-h-[200px] relative">
              <img
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-[#8EA8AA]">{t('أدخل رقم الطلب (مثل FK-98231) لمتابعة حالة الطلب.', 'Enter your order number (e.g. FK-98231) to check status.')}</p>
        </div>

        <form onSubmit={handleTrack} className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-4 shadow-xl">
          <div className="flex gap-2">
            <input
              ...
              className="w-full bg-[#061719] border border-[#0B2528] rounded-xl px-4 py-3 text-xs text-white focus:outline-none focus:border-[#6CC6C9]"
            />
          ...
          {order && (
            <div className="mt-6 pt-6 border-t border-[#0B2528] space-y-6">
              <div className="flex items-center justify-between">
                <div>
                  <span className="font-bold text-white text-sm">{order.order_number}</span>
                  <span className="text-[#8EA8AA] mx-2">|</span>
                  <span className="text-[#B9D0D1] text-xs">{order.customer_name}</span>
                </div>
                ...
                {statusSteps.map((step, idx) => {
                  ...
                  return (
                    <div key={step.key} className={`p-2 rounded-xl font-bold border ${isActive
                        ...
                        : 'bg-[#061719] text-[#8EA8AA] border-[#0B2528]'
                      }`}>
              ...
              {order.status_history && order.status_history.length > 0 && (
                <div className="space-y-2">
                  ...
                  {order.status_history.map((h: any, idx: number) => (
                    <div key={idx} className="flex items-start gap-2 text-xs p-2 rounded-lg bg-[#061719]">
                      ...
                      <div>
                        ...
                        <span className="text-[#8EA8AA] block">{new Date(h.timestamp).toLocaleDateString(language === 'ar' ? 'ar-SA' : 'en-US', { year: 'numeric', month: 'long', day: 'numeric', hour: '2-digit', minute: '2-digit' })}</span>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              {order.tracking_number && (
                <div className="p-3 bg-[#061719] rounded-xl border border-[#0B2528] flex items-center justify-between">
                  <span className="text-[#8EA8AA] text-xs">{t('رقم التتبع', 'Tracking Number')}</span>
              ...
              <button
                ...
                className="w-full text-center text-[#8EA8AA] hover:text-[#6CC6C9] text-xs font-bold py-2 transition cursor-pointer"
              >
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-[#8EA8AA]">{t('مقالات ودراسات حول القهوة المختصة وطرق التحضير ومصادر المحاصيل.', 'Guides & educational articles on specialty coffee culture.')}</p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {articles.map(art => (
            <div key={art.id} className="bg-[#0A1E20] border border-[#0B2528] rounded-3xl overflow-hidden shadow-xl space-y-4 p-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-[#8EA8AA] line-clamp-2">{art.desc_ar}</p>
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 space-y-8">
        <div className="text-center space-y-3">
          ...
          <p className="text-xs text-[#8EA8AA]">{t('أهدِ من تحب تجربة اختيار محاصيلهم وأدواتهم المفضلة من محمصة سليكشن القهوة.', 'Gift coffee lovers an instant digital voucher for coffee and gear.')}</p>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-6 shadow-xl">
          {purchased ? (
            <div className="text-center space-y-3 p-6 bg-emerald-500/10 border border-emerald-500/30 rounded-2xl">
              ...
              <p className="text-xs text-[#8EA8AA]">{t('تم إرسال كود الهدية للبريد الإلكتروني المدخل.', 'Voucher code dispatched via email.')}</p>
            </div>
          ) : (
            <form onSubmit={(e) => { e.preventDefault(); setPurchased(true); }} className="space-y-4 text-xs">
              <div>
                <label className="block text-[#B9D0D1] mb-2 font-bold">{t('اختر قيمة بطاقة الهدية (﷼):', 'Select Amount (SAR):')}</label>
                <div className="flex gap-2">
                  {[100, 200, 300, 500].map(val => (
                    <button
                      ...
                      className={`flex-1 py-3 rounded-xl font-bold cursor-pointer transition border ${amount === val ? 'bg-[#0E5257] text-white border-[#6CC6C9]' : 'bg-[#061719] text-[#8EA8AA] border-[#0B2528]'
                        }`}
                    >
                      {val} ﷼
                    </button>
              ...
              <div>
                <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('اسم أو بريد المهدى إليه:', 'Recipient Email:')}</label>
                <input
                  type="email"
                  required
                  value={recipient}
