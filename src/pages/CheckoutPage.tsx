...
export const CheckoutPage: React.FC<CheckoutPageProps> = ({ onNavigate }) => {
  ...
  if (!user) {
    return (
      <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-16 px-4">
        <div className="max-w-md mx-auto text-center space-y-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full text-[#8EA8AA] hover:text-white py-2 rounded-2xl text-xs font-bold transition cursor-pointer"
            >
  ...
  return (
    <div className="bg-[#061719] text-[#F3FBFB] min-h-screen py-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        {/* Title Bar */}
        <div className="border-b border-[#0B2528] pb-6 flex items-center justify-between">
          <div>
        ...
        <form onSubmit={handlePlaceOrder} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="p-6 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-4">
              <h3 className="font-extrabold text-base text-white flex items-center gap-2 border-b border-[#0B2528] pb-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div>
                  <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('الاسم الكامل', 'Full Name')}</label>
                  <input
                    type="text"
                    required
                    value={customerName}
                ...
                <div>
                  <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('رقم الجوال (لإشعارات الشحنة والـ SMS)', 'Phone Number')}</label>
                  <input
                    type="tel"
                    required
                    value={phone}
                ...
                <div className="sm:col-span-2">
                  <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('البريد الإلكتروني (لإرسال الفاتورة الضريبية)', 'Email Address')}</label>
                  <input
                    type="email"
                    required
                    value={email}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[#061719] border border-[#0B2528] rounded-xl p-3 text-white focus:outline-none focus:border-[#6CC6C9] cursor-pointer"
                  >
                    {saudiCities.map(c => (
                ...
                <div>
                  <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('الحي', 'District')}</label>
                  <input
                    type="text"
                    required
                ...
                <div className="sm:col-span-2">
                  <label className="block text-[#B9D0D1] mb-1 font-semibold">{t('تفاصيل الشارع', 'Street Address')}</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-2 gap-3 sm:col-span-2">
                  <div>
                    <label className="block text-[10px] text-[#8EA8AA] mb-1">{t('المبنى/الفيلا', 'Building')}</label>
                    <input type="text" value={formData.building} onChange={e => setFormData(prev => ({ ...prev, building: e.target.value }))}
                      className="w-full bg-[#061719] border border-[#0B2528] rounded-xl px-3 py-2.5 text-xs text-white" />
                  </div>
                  <div>
                    <label className="block text-[10px] text-[#8EA8AA] mb-1">{t('الرمز البريدي', 'Postal Code')}</label>
                ...
                <div className="sm:col-span-2">
                  <label className="block text-[10px] text-[#8EA8AA] mb-1">{t('ملاحظات التوصيل', 'Delivery Notes')}</label>
                  ...
                  return (
                    <div
                      ...
                      className={`p-4 rounded-2xl border transition cursor-pointer flex items-center justify-between ${selected
                          ...
                          : 'bg-[#061719] border-[#0B2528] hover:border-[#0E5257]'
                        }`}
                    >
                      <div className="space-y-1">
                        ...
                        <span className="text-[10px] text-[#8EA8AA]">
                        ...
                        {p.imgs.length > 0 ? p.imgs.map(src => (
                          <img
                            ...
                            onError={e => {
                              ...
                              s.className = 'text-[10px] font-extrabold bg-[#0B2528] px-2 py-0.5 rounded text-[#6CC6C9]';
                              s.textContent = p.badge;
                              t.parentNode?.replaceChild(s, t);
                            }}
                          />
                        )) : (
                          <span className="text-[10px] font-extrabold bg-[#0B2528] px-2 py-0.5 rounded text-[#6CC6C9]">
                            {p.badge}
                          </span>
                        )}
                      </span>
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-3xl bg-[#0A1E20] border border-[#0B2528] space-y-5 sticky top-28 shadow-2xl">
              <h3 className="font-extrabold text-base text-white border-b border-[#0B2528] pb-3">
              ...
              <div className="space-y-2 max-h-48 overflow-y-auto pr-1">
                {items.map(item => (
                  <div key={item.id} className="flex justify-between text-xs text-[#B9D0D1]">
              ...
              {/* Math breakdown */}
              <div className="space-y-2 text-xs text-[#B9D0D1] pt-3 border-t border-[#0B2528]">
                ...
                <div className="flex justify-between text-[11px] text-[#8EA8AA]">
                ...
                <div className="flex justify-between text-white font-extrabold text-xl pt-3 border-t border-[#0B2528]">
              ...
              <div className="text-[10px] text-[#8EA8AA] text-center space-y-1">
        ...
        {pendingOrder && isStripeMethod && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
            <div className="w-full max-w-md rounded-3xl bg-[#0A1E20] border border-[#0B2528] p-6 shadow-2xl">
              ...
              <p className="text-xs text-[#B9D0D1] mb-5">
              ...
              {paymentBusy ? (
                <div className="py-10 text-center text-xs text-[#8EA8AA]">
                ...
                <div className="space-y-4">
                  <div className="bg-[#061719] border border-[#0B2528] rounded-2xl p-4 text-xs text-[#B9D0D1] space-y-2">
